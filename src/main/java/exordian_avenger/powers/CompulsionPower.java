...
public class CompulsionPower extends AbstractPower {
    public static final String POWER_ID = "exordian_avenger:compulsion";
    ...
    {
        flash();
        if(AbstractDungeon.player.hasPower("exordian_avenger:compcounter") && AbstractDungeon.player.getPower("exordian_avenger:compcounter").amount > 2)
        {
