...
public class Exordian_avenger implements EditKeywordsSubscriber, PostInitializeSubscriber, EditRelicsSubscriber, EditStringsSubscriber, EditCardsSubscriber, EditCharactersSubscriber, PostDrawSubscriber,OnStartBattleSubscriber  {
	...
	public Exordian_avenger() {
		...
		public void receiveEditCards() {
			...
			BaseMod.addCard(new RelentlessStalling());
			BaseMod.addCard(new Impress());
			BaseMod.addCard(new Overcompensate());
			BaseMod.addCard(new Waitforit());
			BaseMod.addCard(new Dejavu());
			BaseMod.addCard(new Glucosynthesis());
			BaseMod.addCard(new Recklessnes());
			BaseMod.addCard(new StickySaliva());
			BaseMod.addCard(new Ivy());
			BaseMod.addCard(new Prepare());
			BaseMod.addCard(new SplinterStrike());
			BaseMod.addCard(new Benzoquinone());
			BaseMod.addCard(new ContagiousSaliva());
			BaseMod.addCard(new ChargeUpSpit());
			BaseMod.addCard(new RainOfPain());
			BaseMod.addCard(new Boil());
			BaseMod.addCard(new CompulsionCard());
			BaseMod.addCard(new Shock());
			BaseMod.addCard(new Yawn());
			BaseMod.addCard(new Absorb());
			BaseMod.addCard(new Dread());
			BaseMod.addCard(new Shrink());
			BaseMod.addCard(new WebThrow());
			BaseMod.addCard(new Shell());
			BaseMod.addCard(new ReinforcedExoskeleton());
		}
		@Override
